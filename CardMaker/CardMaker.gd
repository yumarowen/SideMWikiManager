...
var CardDataPlusScreen = "res://CardMaker/CardMaker+.tscn"
...
onready var CardDescription2JPN = find_node("Description_2_JPN_Edit")
...
onready var CardDescription2ENG = find_node("Description_2_ENG_Edit")
...
func replace_CardDescription():
	...
	if not CardDescription2JPN.text == "":
		CardTemplateContent = CardTemplateContent.replace("DESCRIP2_JPN",CardDescription2JPN.text)
	else:
		CardTemplateContent = CardTemplateContent.replace("DESCRIP2_JPN","")
	if not CardDescription2ENG.text == "":
		CardTemplateContent = CardTemplateContent.replace("DESCRIP2_ENG",CardDescription2ENG.text)
	else:
		CardTemplateContent = CardTemplateContent.replace("DESCRIP2_ENG","")
